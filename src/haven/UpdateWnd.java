...
public class UpdateWnd extends Window {
    private static final String dwnurl = "https://github.com/Updatoo/hafen-client/releases/download/";
        ...
        Button btn = new Button(200, "Download Update") {
            public void click() {
                ...
                if (desktop != null && desktop.isSupported(Desktop.Action.BROWSE)) {
                    try {
                        desktop.browse(new URI(dwnurl + version + "/porque-" + version + "-upd.zip"));
                    } catch (Exception e) {
                        e.printStackTrace();
                    }
                }
